...
class PostFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cat' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'desc' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-04-24 04:01:02',
                'modified' => '2019-04-24 04:01:02'
            ],
        ];
        parent::init();
    }
